...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, cycle, attn_mask=None, tau=None, delta=None, **kwargs):
        ...
        core = F.gelu(self.gen4(combined_mean))
        ...
        # mlp fusion
        combined_mean_cat = torch.cat([combined_mean, core], -1)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.temporal_proj = nn.Linear(configs.d_model, configs.seq_len)
        self.temporal_proj2 = nn.Linear(configs.seq_len, configs.d_model)
    ...
    def forecast(self, x_enc, cycle_index, x_mark_enc, x_dec, x_mark_dec):
        ...
        dec_out = self.temporal_proj2(x_enc.permute(0,2,1) + self.temporal_proj(enc_out))
